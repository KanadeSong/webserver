...
/**
 * @Description:挖机临时报表查询实体类
 * @Author yueyuzhe
 * @Email 87167070@qq.com
 * @Date 2019/9/29 0029 15:14
 */
@Data
public class ProjectDiggingTempDayReport {

    private Long machineId = 0L;        //挖机ID

    private String machineCode = "";        //挖机编号

    private BigDecimal earlyWorkTimeByTimer = BigDecimal.ZERO;     //计时早班工作时长

    private BigDecimal nightWorkTimeByTimer = BigDecimal.ZERO;     //计时晚班工作时长
    ...
    private BigDecimal earlyWorkTimeByCubic = BigDecimal.ZERO;      //计方早班工作时长

    private BigDecimal nightWorkTimeByCubic = BigDecimal.ZERO;      //计方晚班工作时长
