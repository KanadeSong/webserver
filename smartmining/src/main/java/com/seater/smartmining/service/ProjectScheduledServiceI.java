...
@Deprecated
public interface ProjectScheduledServiceI {
     ...
     List<ProjectScheduled> getByProjectIdAndGroupCode(Long projectId, String groupCode);
     ...
     List<ProjectScheduled> getAllByQuery(Long projectId, String machineCode, String carCode, Integer current, Integer pageSize, PricingTypeEnums pricingType);
