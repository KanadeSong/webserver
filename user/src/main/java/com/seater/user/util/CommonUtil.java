...
import com.seater.user.config.exception.CommonJsonException;
...
//		resultJson.put("code", Constants.SUCCESS_CODE);
	...
	public static JSONObject successJsonData(Object info) {
		JSONObject resultJson = new JSONObject();
//		resultJson.put("code", Constants.SUCCESS_CODE);
...
//		resultJson.put("info", new JSONObject());
    ...
    public static JSONObject errorJson(String errorMsg, Object data) {
        JSONObject resultJson = new JSONObject();
//		resultJson.put("code", errorEnum.getErrorCode());
        resultJson.put("msg", errorMsg);
...
//		resultJson.put("info", new JSONObject());
	...
	public static void hasAllRequired(final JSONObject jsonObject, String requiredColumns) {
		if (StrUtil.isNotEmpty(requiredColumns)) {
			//验证字段非空
    ...
    public static Long getProjectId(HttpServletRequest request) {
        if (!StringUtils.isEmpty(request.getHeader("projectId"))) {
    ...
    public static SysUser getCurrentUser() {
		Object user = SecurityUtils.getSubject().getSession().getAttribute(Constants.SESSION_USER_INFO);
